...
urlpatterns = [
    ...
    path('marketplace/job/<int:job_id>/applicants/', views.applicant_review, name='applicant_review'),
    path('marketplace/proposal/<int:proposal_id>/message/', views.send_acceptance_message, name='send_acceptance_message'),
